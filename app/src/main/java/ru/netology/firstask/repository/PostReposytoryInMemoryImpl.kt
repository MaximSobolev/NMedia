    ...
    private var posts = listOf(
        Post(
            ...
            content = "Освоение новой профессии — это не только открывающиеся возможности и " +
                    ...
                    "зоны комфорта и перестраивать привычный образ жизни: менять распорядок дня, " +
        ...
        Post(
            ...
            content = "Таймбоксинг — отличный способ навести порядок в своём календаре " +
                    ...
                    "главный принцип — на каждое дело заранее выделяется определённый " +
                    "отрезок времени. В это время вы работаете только над одной задачей, не " +
                    "переключаясь на другие. Собрали советы, которые помогут внедрить " +
                    "таймбоксинг \uD83D\uDC47\uD83C\uDFFB",
        ...
        Post(
            ...
            content = "\uD83D\uDE80 24 сентября стартует новый поток бесплатного курса " +
                    ...
                    "недели вы попробуете себя в разных профессиях и определите, что подходит " +
                    "именно вам → http://netolo.gy/fQ",
